...
output_file = 'results/results-scalability-number-of-series-contracted.csv' # the name of the result file
...
with open(output_file, mode, buffering=1) as f:
	...
	for i in range(4, max_exponent+1):
		...
		#  Write results
		result = [nb_series, sast_time_fit, sast_time_test, sast_fixed_time_fit, sast_fixed_time_test, saste_time_fit, saste_time_test, saste_fixed_time_fit, saste_fixed_time_test, stc_time_fit, stc_time_test]
